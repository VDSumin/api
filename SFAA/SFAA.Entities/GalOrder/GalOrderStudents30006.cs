...
namespace SFAA.Entities
{
    ...
    public class GalOrderStudents30006
    {
        [JsonIgnore]
        ...
        /// <summary>
        /// Наименование группы новое
        /// </summary>
        [JsonProperty("groupNameNew")]
        public string GroupNameNew { get; set; }

        /// <summary>
        /// Наименование группы старое
        /// </summary>
        [JsonProperty("groupNameOld")]
