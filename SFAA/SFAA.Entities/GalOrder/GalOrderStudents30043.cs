...
namespace SFAA.Entities
{
    ...
    public class GalOrderStudents30043
    {
        [JsonIgnore]
        ...
        /// <summary>
        /// Источник финансирования аббревиатура
        /// </summary>
        [JsonProperty("finSourceAbbr")]
        public string FinSourceAbbr { get; set; } = string.Empty;
        ...
        /// <summary>
        /// Факультет абберевиатур
        /// </summary>
        [JsonProperty("facultAbbr")]
        public string FacultAbbr { get; set; }

        /// <summary>
        /// Наименование отпуска
        /// </summary>
        [JsonProperty("otpuskName")]
        public string OtpuskName { get; set; }

        /// <summary>
        /// Дата отпуска
        /// </summary>
        [JsonProperty("otpuskDateEnd")]
        public string OtpuskDateEnd { get; set; }

        /// <summary>
        /// Старый отпуск
        /// </summary>
        [JsonProperty("otpuskOLD")]
        public string OtpuskOLD { get; set; }
        ...
        /// </summary>
        [JsonProperty("dogovorProlong")]
        public string DogovorProlong { get; set; }
    }
}
