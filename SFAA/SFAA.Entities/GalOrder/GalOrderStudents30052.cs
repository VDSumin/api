...
namespace SFAA.Entities
{
    ...
    public class GalOrderStudents30052
    {
        [JsonIgnore]
        ...
        /// <summary>
        /// Дата открытия назначения
        /// </summary>
        [JsonProperty("appDate")]
        public string AppDate { get; set; }

        /// <summary>
        /// Наименование уч заведения из которого переводится
        /// </summary>
        [JsonProperty("schoolFrom")]
        ...
        /// <summary>
        /// Признак ликвидации задолжностей
        /// </summary>
        [JsonProperty("indPlan")]
        public string IndPlan { get; set; }
