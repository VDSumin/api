...
namespace SFAA.Entities
{
    ...
    public class GalOrderStudents31030
    {
        [JsonIgnore]
        ...
        /// Тип ИГА
        /// </summary>
        [JsonProperty("typeIGA")]
        public string TypeIGA { get; set; }

        /// <summary>
        /// Перенос ИГА до
        /// </summary>
        [JsonProperty("toDateIGA")]
        public string ToDateIGA { get; set; }
        ...
        /// <summary>
        /// Договор пролонгирован до
        /// </summary>
        [JsonProperty("dogovorDateProlong")]
        public string DogovorDateProlong { get; set; }
