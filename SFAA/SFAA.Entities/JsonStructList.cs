...
namespace SFAA.Entities
{
    ...
    public class JsonStructList
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonStructList"/> class.
        /// </summary>
        public JsonStructList() 
        {
            this.Student = new List<JsonStudentOfList>();
        ...
        /// <summary>
        /// Количесто аудиторных часов из ведомости
        /// </summary>
        [JsonProperty("audHoursList")]
        public int AudHoursList { get; set; } = 0;
        ...
        /// <summary>
        /// Общее количество часов на конкретную дату
        /// </summary>
        [JsonProperty("audHoursCurr")]
        public int AudHoursCurr { get; set; } = 0;
        
        /// <summary>
        /// Дата текущих часов по ведомости
        /// </summary>
        [JsonProperty("dateOfCurHours")]
        public int DateOfCurHours
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Nrec ведомости по курсовой в случае наличия. Необходим при проверке наличия курсовой работы от текущей ведомости
        /// </summary>
        [JsonIgnore]
        public byte[] NrecKursList
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Nrec ведомости при переаттестации и т.д.
        /// </summary>
        [JsonIgnore]
        public List<byte[]> NrecKursListOther
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Nrec ведомости строковый по курсовой в случае наличия. Необходим при проверке наличия курсовой работы от текущей ведомости
        /// </summary>
        [JsonProperty("nreckurs")]
        public string NrecKursListString { get; set; } = string.Empty;
        ...
        public List<JsonStudentOfList> Student
        {
            get;
            set;
        }
